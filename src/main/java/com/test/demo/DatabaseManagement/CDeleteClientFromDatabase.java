...
public class CDeleteClientFromDatabase {
        ...
        public static <Connection> void deleteClient(int ID) throws ClassNotFoundException, SQLException {
            ...
            try (java.sql.Connection connection = DriverManager.getConnection(jdbcUrl, usernameDB, passwordDB)){
                ...
                String insertQuery = "DELETE FROM clients WHERE client_ID = ?;";
